...
static class dfsin
{
  ...
  public static float64 sin (float64 rad)
  {
    ...
    do
      {
        gloops++;
       //System.Console.WriteLine ("inc={0:X}", inc);
       //System.Console.WriteLine ("nn={0:X} dd={1:X}", softfloat.float64_mul (diff, m_rad2),  softfloat.int32_to_float64 ((2 * inc) * (2 * inc + 1)));
	...
	//System.Console.WriteLine(" diff={0:X} app={1:X}", diff, app);
	inc++;
      }
