...
{
  unsigned int test_t1;
  unsigned int test_t2;
  unsigned char T403_test_st0_0_12_V_3_GP;
  unsigned int T403_test_st5_0_27_V_1_GP;
  unsigned int T403_test_st3_0_21_V_3_GP;
  unsigned char T403_test_st0_0_12_V_4;
  unsigned INT64 T403_test_st6_0_30_V_1_GP;
  unsigned int T403_test_st4_0_24_V_0_GP;
  unsigned int T403_test_st6_0_30_V_0_GP;
  sc_uint<5> xpc10nz;
  unsigned int iuMULTIPLIER10RRh10hold;
  sc_uint<1> iuMULTIPLIER10RRh10shot0;
  sc_out  < unsigned INT64 > test_wout;
  ...
  test( sc_core::sc_module_name name)  :    sc_core::sc_module("test")
   { 
       SC_HAS_PROCESS(test);
