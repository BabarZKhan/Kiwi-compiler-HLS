...
#ifndef EthernetEcho_H
#define EthernetEcho_H
#define HPR_NEEDS_SYSTEMC 1
#include "hprls.h"
// opath operation: 10: cgen2

struct  EthernetEcho  : public sc_module
{
  unsigned int T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1__SPILL_256;
  sc_uint<1> T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1_V_0;
  unsigned int T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1_V_1;
  sc_uint<1> T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1_V_3;
  unsigned int T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1_V_2;
  unsigned int T404_LocalLinkLoopBackTest_EthernetEcho_echo_1_1__SPILL_257;
  sc_uint<5> xpc10nz;
  unsigned char Z8USCCSCALbx10ARA0RRh10hold;
  sc_uint<1> Z8USCCSCALbx10ARA0RRh10shot0;
  sc_in < unsigned char > rx_data;
  sc_in < sc_uint<1> > rx_sof_n;
  sc_in < sc_uint<1> > rx_eof_n;
  sc_in < sc_uint<1> > rx_src_rdy_n;
  sc_out  < unsigned char > tx_data;
  sc_out  < sc_uint<1> > tx_sof_n;
  sc_out  < sc_uint<1> > tx_eof_n;
  sc_out  < sc_uint<1> > tx_src_rdy_n;
  sc_in < sc_uint<1> > tx_dst_rdy_n;
  ...
  unsigned char _8_US_CC_SCALbx10_ARA0[1024];
  sc_in < sc_uint<1> > clk;
  sc_in < sc_uint<1> > reset;
  unsigned char _8_US_CC_SCALbx10_ARA0_RDD0;
  sc_uint<10> _8_US_CC_SCALbx10_ARA0_AD0;
  sc_uint<1> _8_US_CC_SCALbx10_ARA0_WEN0;
  sc_uint<1> _8_US_CC_SCALbx10_ARA0_REN0;
  unsigned char _8_US_CC_SCALbx10_ARA0_WRD0;

  EthernetEcho( sc_core::sc_module_name name)  :    sc_core::sc_module("EthernetEcho")
   { 
       SC_HAS_PROCESS(EthernetEcho);
