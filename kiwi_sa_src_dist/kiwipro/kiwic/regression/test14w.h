...
struct  test14w  : public sc_module
{
  unsigned int test14w_T402_Main_T402_Main_V_2;
  sc_uint<1> test14w_T402_Main_T402_Main_V_0a;
  sc_uint<1> test14w_T402_Main_T402_Main_V_1a;
  ...
  test14w( sc_core::sc_module_name name)  :    sc_core::sc_module("test14w")
   { 
       SC_HAS_PROCESS(test14w);
