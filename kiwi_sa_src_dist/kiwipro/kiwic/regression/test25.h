...
struct  test25  : public sc_module
{
  sc_uint<1> test25_T402_Main_T402_Main_V_0;
  sc_uint<1> test25_T402_Main_T402_Main_V_1;
  unsigned int test25_T402_Main_T402_Main_V_2;
  sc_uint<3> xpc10nz;
  sc_in < sc_uint<1> > clk;
  ...
  test25( sc_core::sc_module_name name)  :    sc_core::sc_module("test25")
   { 
       SC_HAS_PROCESS(test25);
