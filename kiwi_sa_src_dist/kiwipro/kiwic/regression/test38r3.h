...
struct  test38r3  : public sc_module
{
  unsigned int test38r3_T402_Main_T402_Main_V_1;
  unsigned int test38r3_T402_Main_T402_Main_V_2;
  ...
  test38r3( sc_core::sc_module_name name)  :    sc_core::sc_module("test38r3")
   { 
       SC_HAS_PROCESS(test38r3);
