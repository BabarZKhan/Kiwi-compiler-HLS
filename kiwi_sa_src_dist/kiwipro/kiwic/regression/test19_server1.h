...
#ifndef test19_server1_H
#define test19_server1_H
#define HPR_NEEDS_SYSTEMC 1
#include "hprls.h"
// opath operation: 10: cgen2

struct  test19_server1  : public sc_module
{
  unsigned int T403_test19_client1_framestore_draw_diagonal_0_8_V_0;
  unsigned int T403_test19_client1_framestore_draw_diagonal_0_8_V_1;
  sc_uint<5> xpc10nz;
  sc_in < sc_uint<1> > clk;
  sc_out  < sc_uint<1> > test19_server1_setget_pixel_req;
  sc_in < sc_uint<1> > test19_server1_setget_pixel_ack;
  sc_in < unsigned char > test19_server1_setget_pixel_return;
  sc_out  < unsigned char > test19_server1_setget_pixel_wdata;
  sc_out  < sc_uint<1> > test19_server1_setget_pixel_readf;
  sc_out  < unsigned int > test19_server1_setget_pixel_y;
  sc_out  < unsigned int > test19_server1_setget_pixel_x;
  sc_out  < sc_uint<1> > test19_server1_start_req;
  sc_in < sc_uint<1> > test19_server1_start_ack;
  sc_out  < sc_uint<1> > test19_server1_get_id_req;
  sc_in < sc_uint<1> > test19_server1_get_id_ack;
  sc_in < unsigned int > test19_server1_get_id_return;
  ...
  test19_server1( sc_core::sc_module_name name)  :    sc_core::sc_module("test19_server1")
   { 
       SC_HAS_PROCESS(test19_server1);
